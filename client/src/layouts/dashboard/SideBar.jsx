...
const Sidebar = () => {
  const data = {
    fullName: "issam",
    username: "merighed",
    profileImg: faker.image.city(),
  };

  return (
    <div className="md:flex-[2_2_0] max-h-screen h-screen pt-3 w-18 shadow-lg">
      <div className="left-0 flex flex-col h-full w-20 md:w-full">
